...
export function ProgramarMantenimiento({
	...
	return (
		<>
			<p className='text-label-md text-[var(--color-on-surface-variant)] mb-2 -mt-2'>
				Planificación de mantenimiento preventivo
			</p>
			<form onSubmit={handleSubmit} className='space-y-2'>
				{/* Card: Equipo y Tipo */}
				<div className='bg-[var(--color-surface-container-lowest)] p-4 rounded-2xl shadow-card space-y-4 border border-[var(--color-outline-variant)]/30'>
				...
				{/* Card: Programación */}
				<div className='bg-[var(--color-surface-container-lowest)] p-4 rounded-2xl shadow-card space-y-5 border border-[var(--color-outline-variant)]/30'>
					<div className='flex items-center gap-3 mb-2'>
